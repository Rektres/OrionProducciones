...
<template>
  <a
    ...
    class="position-fixed d-flex align-items-center justify-content-center rounded-circle shadow whatsapp-pulse hover-scale"
    style="bottom: 2rem; right: 2rem; z-index: 1040; width: 56px; height: 56px; background: #25d366; color: #fff"
